...
(function(root, factory) {
  ...
  return function Swipe(container, options) {
    ...
    var continuous = (options.continuous = options.continuous !== undefined
      ? options.continuous
      : true);
    ...
    function translate(index, dist, speed) {
      ...
      style.msTransform = (style.MozTransform = (style.OTransform = 'translateX(' +
        dist +
        'px)'));
    }
